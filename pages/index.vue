...
export default {
  async asyncData (context) {
    const { data: todoItems } = await axios.get(`${todoApiUrl}/todo/TODO`)
    const { data: progressItems } = await axios.get(`${todoApiUrl}/todo/PROGRESS`)
    const { data: doneItems } = await axios.get(`${todoApiUrl}/todo/DONE`)
    return {
      todoItems,
      progressItems,
      doneItems
